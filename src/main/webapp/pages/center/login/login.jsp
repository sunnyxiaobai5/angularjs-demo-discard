...
<c:url value="/loginForm" var="loginProcessingUrl"/>
<body class="login">
            ...
            <div class="content">
                ...
                <form class="login-form" action="${loginProcessingUrl}" method="post">
                    ...
                    <div class="form-group has-error">
                        ...
                        <label class="control-label visible-ie8 visible-ie9">请输入您的帐号</label>
                        <div class="input-icon">
                            <i class="fa fa-user"></i>
                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="请输入您的帐号" id="username" name="username" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="请输入您的密码" id="password" name="password" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="">
