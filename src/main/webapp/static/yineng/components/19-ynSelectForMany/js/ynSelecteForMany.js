/**
 * Created by LiaoHao on 2015/6/1.
 */
angular.module("yn.utils").directive("ynSelectForMany",function(){
    return {
        restrict:"AE",
        scope:{
            option:'=',
        ...
        templateUrl:function(tElement, tAttrs) {
            ...
            return basePath + "/static/yineng/components/19-ynSelectForMany/template/"+theme+".html";
        },
